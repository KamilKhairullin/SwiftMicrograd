...
final class ValueTestsMul: XCTestCase {
    ...
    func testValue_mul_negative() throws {
        let value1 = ValueTestsUtils.makeValue1()
    ...
    func testValue_mul_negative_double() throws {
        let value1 = ValueTestsUtils.makeValue1()
    ...
    func test_backpropagation_mul() {
        ...
        ValueTestsUtils.assertDouble(value1.gradient, 24.0)
        ValueTestsUtils.assertDouble(value2.gradient, 12.0)
        ValueTestsUtils.assertDouble(value3.gradient, 8.0)
        ValueTestsUtils.assertDouble(value4.gradient, 6.0)
        ValueTestsUtils.assertDouble(value5.gradient, 12.0)
        ValueTestsUtils.assertDouble(value6.gradient, 2.0)
