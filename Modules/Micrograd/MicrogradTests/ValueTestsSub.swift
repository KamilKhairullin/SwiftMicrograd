...
final class ValueTestsSub: XCTestCase {
    ...
    func testValue_sub_negative() throws {
        let value1 = ValueTestsUtils.makeValue1()
    ...
    func testValue_sub_negative_double() throws {
        let value1 = ValueTestsUtils.makeValue1()
    ...
    func test_backpropagation_sub() {
        let value1 = Value(data: 0.11)
        let value2 = Value(data: 0.55)
        let value3 = Value(data: 0.58)
        let value4 = Value(data: 0.47)
